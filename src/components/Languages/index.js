...
const Languages = ({ location, lang }) => {
  ...
  console.log(currentLocation, lang, currentUrl)

  return (
    <div className={styles.languages}>
      <p>
        <Link to={currentUrl && currentUrl.url_en} className={`${styles.language_item} ${lang === 'en' ? styles.language_active : ''}`}>en</Link>
        <span> / </span>
        ...
        <span> / </span>
        <Link to={currentUrl && currentUrl.url_de} className={`${styles.language_item} ${lang === 'de' ? styles.language_active : ''}`}>de</Link>
      </p>
    </div>
  )
} 
