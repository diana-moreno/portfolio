      ...
      <nav className={openMenu ? styles.menu_hamburger_fixed : styles.menu_hamburger}>
        ...
        </button>
        {
          ...
          <ul className={styles.menu_hamburger_list}>
            <li className={indexMenu === 0 ? styles.active : ''}>
              <Link onClick={toggleMenu} to={allUrls[1][`url_${lang}`]}>{t('home.title', lang)}</Link>
            </li>
            <li className={indexMenu === 1 ? styles.active : ''}>
              <Link onClick={toggleMenu} to={allUrls[2][`url_${lang}`]}>{t('about.title', lang)}</Link>
            </li>
            <li className={indexMenu === 2 ? styles.active : ''}>
              <Link onClick={toggleMenu} to={allUrls[3][`url_${lang}`]}>{t('projects.title', lang)}</Link>
            </li>
            <li className={indexMenu === 3 ? styles.active : ''}>
              <Link onClick={toggleMenu} to={allUrls[4][`url_${lang}`]}>{t('contact.title', lang)}</Link>
            </li>
          </ul>
        }
      </nav>
